...
!============================================================
 ...
 real(8) volume_r,volume_g,lattice_parameter,latticeparameters(6), &
 &       primitivelattice(3,3),prim_to_cart(3,3),cart_to_prim(3,3)
 real(8) box(3),boxg(3)
 real(8) r0g(3,3)
...
!-----------------------------------------------------------------------
      subroutine bringtocell(cart_to_prim,prim_to_cart,v1,v2)

!! bring a point v1 into v2 in the unit cell at the origin
!! cart_to_prim has the reciprocal lattice vectors in lines 1,2,3
!! prim_to_cart has the real lattice vectors in columns 1,2,3
