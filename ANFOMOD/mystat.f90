...
! error of mean
      write(*,'(''sigma    '',e20.5)')sqrt(v*rkappa/n)
      return
      end
!============================================
...
! blocking analysis
      ...
      real*8 a(n),ab,error,error2,average,average2,average3,average4
...
! estimated error of mean at this block size
       ...
       error2=(2*isize-1)*(average2-average**2)/(n-1)
       write(2,5)isize,error,error2,average,average2,average3,average4
      enddo
