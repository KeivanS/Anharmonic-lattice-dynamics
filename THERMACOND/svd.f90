!===========================================================
 subroutine svd_set(m3,n,a,b,x,sig,svdcut,error,ermax)
! use mappings
 implicit none
...
! real(8) u(m3,n),v(n,n),w(n)
 ...
 real(8) prod,wmax,wmin,svdcut,junk
...
!    endif
  ...
  enddo
  error = error /(1.*m3)
  write(uio,3)' Average and largest errors in force=',error,ermax
6 format(i6,3(1x,g12.6),3x,g10.4)
