...
! ksubset(1) and ksubset(2) are needed for the loops in the follwoing subroutines (calculate_w3_ibz_split_sq,calculate_FGR_mpi)
  ...
  allocate(isempi_em(ksubset(2)-ksubset(1)+1))
  allocate(rsempi_em(ksubset(2)-ksubset(1)+1))
...
! write(*,*)num_k_mpi2,num_k_mpi,local_num_k_mpi, nprocs_mpi, mod(num_k_mpi,nprocs_mpi)
 ...
 ! allocate(tse_tempmpi(num_k_mpi2*ndyn))
  ...
  !allocate(tse_mpi(num_k_mpi2,ndyn))
   ...
   allocate(ise_emmpi(num_k_mpi2))
   allocate(rse_emmpi(num_k_mpi2))
...
!  call MPI_Allgatherv(tse_temp_mpi,ncount2_mpi,MPI_DOUBLE_PRECISION,tse_tempmpi,aksub_mpi,displs_mpi,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr_mpi)
  ...
  call MPI_Allgatherv(isempi_em,ncount1_mpi,MPI_DOUBLE_PRECISION,ise_empmpi,aksub_mpi1,displs_mpi1,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr_mpi)
  call MPI_Allgatherv(rsempi_em,ncount1_mpi,MPI_DOUBLE_PRECISION,rse_empmpi,aksub_mpi1,displs_mpi1,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr_mpi)
  call MPI_Allgatherv(reflectivitympi,ncount1_mpi,MPI_DOUBLE_PRECISION,reflectivity_empmpi,aksub_mpi1,displs_mpi1,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr_mpi)
   call MPI_Allgatherv(chi_temp_mpi,ncount2_mpi,MPI_DOUBLE_PRECISION,chi_tempmpi,aksub_mpi2,displs_mpi2,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr_mpi)
