...
!     iatom (output), index of atom in supercell. Returns zero if not found
      use geometry
      use lattice
      use ios
...
! find direct coordinates of n3 - n(j) :=a and see if it is integer
...
!============================================================
 subroutine get_components_g(q,n,i,j,k,g1,g2,g3,inside)
...
! write(*,8)'q=',q 
! write(*,8)'w=',w 
 call get_components_g(w,n,i,j,k,g1,g2,g3,inside)
